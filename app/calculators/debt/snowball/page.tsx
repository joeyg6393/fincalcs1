...
export default function DebtSnowballCalculator() {
  const [debts, setDebts] = useState<Debt[]>([
    { id: '1', name: 'Credit Card 1', balance: 5000, rate: 18.9, minimumPayment: 100 },
    { id: '2', name: 'Credit Card 2', balance: 3000, rate: 15.9, minimumPayment: 60 },
  ]);
  ...
  const {
    ...
    totalMonths,
    totalInterest,
  } = calculateDebtRepayment(debts, monthlyPayment, 'snowball');
  ...
  return (
    <CalculatorLayout
      ...
      description="Use the debt snowball method to pay off your debts, starting with the smallest balance first."
      groupId="debt"
